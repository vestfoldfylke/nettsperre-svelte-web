export const schoolInfoVFK = [
    ...
    {
        officeLocation: 'Skolen for sosialmedisinske institusjoner', 
        primaryLocation: 'Skolen for sosialmedisinske institusjoner', 
    },
    {
        officeLocation: 'Kompetansebyggeren', 
        primaryLocation: 'Kompetansebyggeren', 
    }
]